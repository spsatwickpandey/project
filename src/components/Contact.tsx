      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            <motion.button
              type="submit"
              className="w-full px-6 py-4 bg-gradient-to-r from-primary via-purple-500 to-pink-500 text-white rounded-xl font-medium flex items-center justify-center group hover:shadow-lg  hover:from-pink-500 hover:to-yellow-400 transition-all disabled:opacity-50"
