      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        <div className="text-left space-y-6 px-4 md:px-0">
          <div className="space-y-2">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-poppins font-bold bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-transparent bg-clip-text transition-all duration-500 hover:from-pink-500 hover:to-yellow-400 ">
              Satwick Pandey
            </h1>
          ...
          <a
            ...
            download
            className="group inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 text-white w-full sm:w-auto justify-center hover:from-pink-500 hover:to-yellow-400 transition-colors"
          >
